...
export default function RenterCheckinAssetPage() {
  ...
  const handleConfirm = () => {
    setConfirming(true);
    // TODO: Call API to confirm check-in asset
    setTimeout(() => {
      setConfirming(false);
      message.success("Check-in asset confirmation submitted successfully!");
    }, 1200);
  };
        ...
        <div style={{ width: "100%", maxWidth: 900 }}>
          <Card style={{ borderRadius: 12, boxShadow: "0 2px 8px rgba(0,0,0,0.1)" }}>
            ...
            <Text type="secondary" style={{ fontSize: isMobile ? 13 : 16 }}>
              Please review and confirm the condition of each asset when you move in.
            </Text>
